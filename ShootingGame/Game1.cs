...
namespace ShootingGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            backgrounnd_Sprite = Content.Load<Texture2D>("sky");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(backgrounnd_Sprite, new Vector2(0, 0), Color.White);

            if (timer > 0)
            {
                spriteBatch.Draw(target_Sprite, new Vector2(targetPosition.X - TARGET_RADIUS, targetPosition.Y - TARGET_RADIUS), Color.White);
            }
            //spriteBatch.Draw(crosshair_Sprite, new Vector2(100, 100), Color.White);

            spriteBatch.DrawString(gameFont, "Score: " + score.ToString(), new Vector2(3, 3), Color.Black);
            spriteBatch.DrawString(gameFont, "Time: " + Math.Ceiling(timer).ToString(), new Vector2(3, 40), Color.AntiqueWhite);
